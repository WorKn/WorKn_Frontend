...
const JumbotronComponent = ({ params: { imageUrl } }) => (
  <div className="jumbotron-container">
    ...
    <div className="jumbotron-container__jumbotron-text">
      ...
      <p className="jumbotron-container__description">
        Encargándonos de unir automáticamente{" "}
        <b className="tooltip">
          profesionales{" "}
          <span className="tooltiptext">
            En búsqueda de incorporarse en una organización que aproveche su
            conocimiento.
          </span>
        </b>
        ,{" "}
        ...
        <b className="tooltip">
          <span className="tooltiptext">
            Un freelancer es un trabajador independiente de cualquier
            organización.
          </span>{" "}
          freelancers
        </b>{" "}
        en nuestra plataforma mediante{" "}
        <b className="tooltip">
          ofertas
          <span className="tooltiptext">
